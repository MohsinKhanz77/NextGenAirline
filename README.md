...
The system is designed to simulate a real-world airline reservation platform where users can:
...
Cancel reservations
Manage flight records efficiently
🗄️ Ticket Database
...
Lucide Icons	Icons and visuals
